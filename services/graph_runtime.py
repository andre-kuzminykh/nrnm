...
def _synthesize_step(step: PlanStep, state: GraphState) -> Any:
    ...
    system_msg = (
        ...
        "- RIGHT AFTER each [N], put the URL in parentheses: [1](https://url)\n"
        "- Example: 'Рынок вырос [1](https://ifr.org/report) и продолжает расти [2](https://example.com).'\n"
        "- Do NOT add a separate list of sources at the end.\n"
        "- The [N](url) format is mandatory for every citation.\n"
